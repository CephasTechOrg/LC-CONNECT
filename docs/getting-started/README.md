...
Setup, daily workflow, and deployment.

| Doc | What it's for |
|-----|---------------|
| [`local_dev_setup.md`](./local_dev_setup.md) | **First-time Mac setup** — Xcode, Simulator, Flutter, CocoaPods, Postgres, env, migrations |
| [`daily_dev_start.md`](./daily_dev_start.md) | **Daily start** — bring up Postgres, backend, Simulator, Flutter |
