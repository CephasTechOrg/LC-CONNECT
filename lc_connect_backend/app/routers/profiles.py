...
from app.models import Interest, Language, LookingForOption, Profile, User, UserLanguage
...
async def get_my_profile(current_user: User = Depends(get_current_user), db: AsyncSession = Depends(get_db)) -> ProfilePublic:
